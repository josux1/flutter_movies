...
void _movieSerialize(
  ...
  writer.writeLong(offsets[3], object.id2);
...
Movie _movieDeserialize(
  ...
  final object = Movie(
    ...
    id2: reader.readLongOrNull(offsets[3]),
...
extension MovieQueryFilter on QueryBuilder<Movie, Movie, QFilterCondition> {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> id2IsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'id2',
      ));
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> id2IsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'id2',
      ));
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> id2EqualTo(int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'id2',
        value: value,
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> id2GreaterThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> id2LessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> id2Between(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension MovieQuerySortBy on QueryBuilder<Movie, Movie, QSortBy> {
  ...
  QueryBuilder<Movie, Movie, QAfterSortBy> sortById2() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id2', Sort.asc);
    });
  }

  QueryBuilder<Movie, Movie, QAfterSortBy> sortById2Desc() {
    return QueryBuilder.apply(this, (query) {
...
extension MovieQuerySortThenBy on QueryBuilder<Movie, Movie, QSortThenBy> {
  ...
  QueryBuilder<Movie, Movie, QAfterSortBy> thenById2() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id2', Sort.asc);
    });
  }

  QueryBuilder<Movie, Movie, QAfterSortBy> thenById2Desc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'id2', Sort.desc);
    });
  }
...
extension MovieQueryWhereDistinct on QueryBuilder<Movie, Movie, QDistinct> {
  ...
  QueryBuilder<Movie, Movie, QDistinct> distinctById2() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'id2');
    });
  }
...
extension MovieQueryProperty on QueryBuilder<Movie, Movie, QQueryProperty> {
  ...
  QueryBuilder<Movie, int?, QQueryOperations> id2Property() {
    return QueryBuilder.apply(this, (query) {
